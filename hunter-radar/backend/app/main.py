...
# 见 etl/log_compat.py(单一来源):etl/*.py 用 structlog 风格 log.info("foo.bar", k=v)。
# 这里 import 触发垫片安装, 保证 app 进程内任何 Logger 都支持 kwargs。
from etl.log_compat import _patch_logger_log  # noqa: E402
